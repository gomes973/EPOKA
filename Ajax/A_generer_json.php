...
if ($doc->schemaValidate("../xml/validate.xsd")) {
    $doc->save("../xml/json.xml");
    $xml = simplexml_load_file("../xml/json.xml");
    $json = json_encode($xml);
    $fileJson = fopen("../xml/Json.json", "w+");
    fputs($fileJson, $json);
    fclose($fileJson);
    ...
    echo 'Probleme de création du fichier Jsons';
}
